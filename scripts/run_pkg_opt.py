...
class DS6(models.DeepSetsModel):
    N_TYPES = 6
    MAX_EL = 12   # ordered multi-via chains need 9 tokens; capacity only,
                  # architecture and parameter count unchanged
...
def train_stack():
    ...
    viamod = via_task.make_via_model_family(400, seed=11)
